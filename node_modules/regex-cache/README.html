<h1>regex-cache <a href="https://www.npmjs.com/package/regex-cache"><img src="https://img.shields.io/npm/v/regex-cache.svg?style=flat" alt="NPM version"></a> <a href="https://npmjs.org/package/regex-cache"><img src="https://img.shields.io/npm/dm/regex-cache.svg?style=flat" alt="NPM downloads"></a> <a href="https://travis-ci.org/jonschlinkert/regex-cache"><img src="https://img.shields.io/travis/jonschlinkert/regex-cache.svg?style=flat" alt="Build Status"></a></h1><blockquote>
<p>Memoize the results of a call to the RegExp constructor, avoiding repetitious runtime compilation of the same string and options, resulting in suprising performance improvements.</p>
</blockquote>
<h2>Install</h2><p>Install with <a href="https://www.npmjs.com/">npm</a>:</p>
<pre><code class="language-sh">$ npm install regex-cache --save
</code></pre>
<ul>
<li>Read <a href="#what-this-does">what this does</a>.</li>
<li>See <a href="#benchmarks">the benchmarks</a></li>
</ul>
<h2>Usage</h2><p>Wrap a function like this:</p>
...
<h2>Recommendations</h2><h3>Use this when...</h3><ul>
...
<h3>Example benchmarks</h3><p>Performance results, with and without regex-cache:</p>
...
<h2>What this does</h2><p>If you&#39;re using <code>new RegExp(&#39;foo&#39;)</code> instead of a regex literal, it&#39;s probably because you need to dyamically generate a regex based on user options or some other potentially changing factors.</p>
...
<h2>Contributing</h2><p>Pull requests and stars are always welcome. For bugs and feature requests, <a href="https://github.com/jonschlinkert/regex-cache/issues/new">please create an issue</a>.</p>
...
Released under the <a href="https://github.com/jonschlinkert/regex-cache/blob/master/LICENSE">MIT license</a>.</p>
<hr>
