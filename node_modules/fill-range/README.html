<h1>fill-range <a href="http://badge.fury.io/js/fill-range"><img src="https://badge.fury.io/js/fill-range.svg" alt="NPM version"></a>  <a href="https://travis-ci.org/jonschlinkert/fill-range"><img src="https://travis-ci.org/jonschlinkert/fill-range.svg" alt="Build Status"></a></h1><blockquote>
<p>Fill in a range of numbers or letters, optionally passing an increment or multiplier to use.</p>
</blockquote>
<h2>Install with <a href="npmjs.org">npm</a></h2><pre><code class="language-bash">npm i fill-range --save
</code></pre>
<!-- toc -->
<ul>
...
<li><a href="#special-characters">Special characters</a><ul>
...
<!-- tocstop -->
<h2>Usage</h2><pre><code class="language-js">var range = require(&#39;fill-range&#39;);
...
<li><code>options</code>: <strong>{Object}</strong>:<ul>
...
<h3>Invalid ranges</h3><p>When an invalid range is passed, <code>null</code> is returned. </p>
...
<h3>Custom function</h3><p>Optionally pass a custom function as the third or fourth argument:</p>
...
<h3>Special characters</h3><p>A special character may be passed as the third arg instead of a step increment. These characters can be pretty useful for brace expansion, creating file paths, test fixtures and similar use case.</p>
...
<h4>plus</h4><p>Character: <em>(<code>+</code>)</em></p>
...
<h4>pipe and tilde</h4><p>Characters: <em>(<code>|</code> and <code>~</code>)</em></p>
...
<h4>angle bracket</h4><p>Character: <em>(<code>&gt;</code>)</em></p>
...
<h4>question mark</h4><p>Character: <em>(<code>?</code>)</em></p>
...
<h2>Contributing</h2><p>Pull requests and stars are always welcome. For bugs and feature requests, <a href="https://github.com/jonschlinkert/fill-range/issues">please create an issue</a></p>
...
<h2>License</h2><p>Copyright (c) 2014-2015 Jon Schlinkert<br>Released under the MIT license</p>
<hr>
