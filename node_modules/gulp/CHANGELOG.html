<h1>gulp changelog</h1><h2>3.9.0</h2><ul>
...
<li>add JSCS</li>
<li>update dependecies (liftoff, interpret)</li>
...
<pre><code class="language-js">gulp.src(&#39;lib/*.js&#39;)
  .pipe(uglify())
...
<li>added support for transpilers via liftoff 0.11 and interpret<ul>
...
<li>Logging moved to CLI bin file<ul>
