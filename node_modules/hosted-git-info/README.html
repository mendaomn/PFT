<h1>hosted-git-info</h1><p>This will let you identify and transform various git hosts URLs between
protocols.  It also can tell you what the URL is for the raw path for
particular file for direct access without git.</p>
<h2>Usage</h2><pre><code class="language-javascript">var hostedGitInfo = require(&quot;hosted-git-info&quot;)
...
<p>eg, <code>https://github.com/npm/hosted-git-info/tree/v1.2.0</code></p>
<ul>
<li>info.bugs()</li>
</ul>
...
<h2>Supported hosts</h2><p>Currently this supports Github, Bitbucket and Gitlab. Pull requests for
