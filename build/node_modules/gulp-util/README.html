...
<h2>Usage</h2><pre><code class="language-javascript">var gutil = require(&#39;gulp-util&#39;);
...
<h3>log(msg...)</h3><p>Logs stuff. Already prefixed with [gulp] and all that. If you pass in multiple arguments it will join them by a space.</p>
<p>The default gulp coloring using gutil.colors.<color>:</p>
<pre><code>values (files, module names, etc.) = cyan
numbers (times, counts, etc) = magenta
</code></pre><h3>colors</h3><p>Is an instance of <a href="https://github.com/sindresorhus/chalk">chalk</a>.</p>
<h3>replaceExtension(path, newExtension)</h3><p>Replaces a file extension in a path. Returns the new path.</p>
<h3>isStream(obj)</h3><p>Returns true or false if an object is a stream.</p>
<h3>isBuffer(obj)</h3><p>Returns true or false if an object is a Buffer.</p>
<h3>template(string[, data])</h3><p>This is a lodash.template function wrapper. You must pass in a valid gulp file object so it is available to the user or it will error. You can not configure any of the delimiters. Look at the <a href="http://lodash.com/docs#template">lodash docs</a> for more info.</p>
<h2>new File(obj)</h2><p>This is just <a href="https://github.com/wearefractal/vinyl">vinyl</a></p>
<pre><code class="language-javascript">var file = new gutil.File({
  base: path.join(__dirname, &#39;./fixtures/&#39;),
  cwd: __dirname,
  path: path.join(__dirname, &#39;./fixtures/test.coffee&#39;)
});
</code></pre>
<h2>noop()</h2><p>Returns a stream that does nothing but pass data straight through.</p>
<pre><code class="language-javascript">// gulp should be called like this :
...
<h2>buffer(cb)</h2><p>This is similar to es.wait but instead of buffering text into one string it buffers anything into an array (so very useful for file objects).</p>
...
<pre><code class="language-javascript">gulp.src(&#39;stuff/*.js&#39;)
  .pipe(gutil.buffer(function(err, files) {

  }));
</code></pre>
<h2>new PluginError(pluginName, message[, options])</h2><ul>
...
<pre><code class="language-javascript">var err = new gutil.PluginError(&#39;test&#39;, {
