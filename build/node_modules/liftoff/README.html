...
<h2>What is it?</h2><p><a href="http://weblog.bocoup.com/building-command-line-tools-in-node-with-liftoff/">See this blog post</a>, <a href="https://github.com/js-cli/js-hacker">check out this proof of concept</a>, or read on.</p>
...
<h2>API</h2><h3>constructor(opts)</h3><p>Create an instance of Liftoff to invoke your application.</p>
<p>An example utilizing all options:</p>
<pre><code class="language-js">const Hacker = new Liftoff({
  name: &#39;hacker&#39;,
  processTitle: &#39;hacker&#39;,
  moduleName: &#39;hacker&#39;,
...
<h4>opts.name</h4><p>Sugar for setting <code>processTitle</code>, <code>moduleName</code>, <code>configName</code> automatically.</p>
<p>Type: <code>String</code><br>Default: <code>null</code></p>
<p>These are equivalent:</p>
<pre><code class="language-js">const Hacker = Liftoff({
  processTitle: &#39;hacker&#39;,
  moduleName: &#39;hacker&#39;,
  configName: &#39;hackerfile&#39;
});
</code></pre>
<pre><code class="language-js">const Hacker = Liftoff({name:&#39;hacker&#39;});
</code></pre>
<h4>opts.moduleName</h4><p>Sets which module your application expects to find locally when being run.</p>
<p>Type: <code>String</code><br>Default: <code>null</code></p>
<h4>opts.configName</h4><p>Sets the name of the configuration file Liftoff will attempt to find.  Case-insensitive.</p>
<p>Type: <code>String</code><br>Default: <code>null</code></p>
<h4>opts.extensions</h4><p>Set extensions to include when searching for a configuration file.  If an external module is needed to load a given extension (e.g. <code>.coffee</code>), the module name should be specified as the value for the key.</p>
...
<pre><code class="language-js">const MyApp = new Liftoff({
  name: &#39;myapp&#39;,
  extensions: {
    &#39;.js&#39;: null,
    &#39;.json&#39;: null,
...
<h4>opts.processTitle</h4><p>Sets what the <a href="http://nodejs.org/api/process.html#process_process_title">process title</a> will be.</p>
<p>Type: <code>String</code><br>Default: <code>null</code></p>
<h4>opts.completions(type)</h4><p>A method to handle bash/zsh/whatever completions.</p>
<p>Type: <code>Function</code><br>Default: <code>null</code></p>
<h2>launch(opts, callback(env))</h2><p>Launches your application with provided options, builds an environment, and invokes your callback, passing the calculated environment as the first argument.</p>
<h5>Example Configuration w/ Options Parsing:</h5><pre><code class="language-js">const Liftoff = require(&#39;liftoff&#39;);
...
<h4>opts.cwd</h4><p>Change the current working directory for this launch. Relative paths are calculated against <code>process.cwd()</code>.</p>
<p>Type: <code>String</code><br>Default: <code>process.cwd()</code></p>
<p><strong>Example Configuration:</strong></p>
<pre><code class="language-js">const argv = require(&#39;minimist&#39;)(process.argv.slice(2));
MyApp.launch({
  cwd: argv.cwd
}, invoke);
</code></pre>
...
<pre><code>myapp --cwd ../
</code></pre><h4>opts.configPath</h4><p>Don&#39;t search for a config, use the one provided. <strong>Note:</strong> Liftoff will assume the current working directory is the directory containing the config file unless an alternate location is explicitly specified using <code>cwd</code>.</p>
<p>Type: <code>String</code><br>Default: <code>null</code></p>
<p><strong>Example Configuration:</strong></p>
<pre><code class="language-js">var argv = require(&#39;minimist&#39;)(process.argv.slice(2));
MyApp.launch({
  configPath: argv.myappfile
}, invoke);
</code></pre>
...
</code></pre><h4>opts.require</h4><p>A string or array of modules to attempt requiring from the local working directory before invoking the launch callback.</p>
...
<p><strong>Matching CLI Invocation:</strong></p>
<pre><code class="language-js">myapp --require coffee-script/register
</code></pre>
<h4>callback(env)</h4><p>A function to start your application.  When invoked, <code>this</code> will be your instance of Liftoff. The <code>env</code> param will contain the following keys:</p>
<ul>
...
<h3>events</h3><h4>require(name, module)</h4><p>Emitted when a module is pre-loaded.</p>
<pre><code class="language-js">var Hacker = new Liftoff({name:&#39;hacker&#39;});
...
<h4>requireFail(name, err)</h4><p>Emitted when a requested module cannot be preloaded.</p>
<pre><code class="language-js">var Hacker = new Liftoff({name:&#39;hacker&#39;});
Hacker.on(&#39;requireFail&#39;, function (name, err) {
  console.log(&#39;Unable to load:&#39;, name, err);
});
</code></pre>
<h4>respawn(flags, child)</h4><p>Emitted when Liftoff re-spawns your process (when a <a href="#optsnodeflags"><code>nodeFlag</code></a> is detected).</p>
<pre><code class="language-js">var Hacker = new Liftoff({
  name: &#39;hacker&#39;,
  nodeFlags: [&#39;--harmony&#39;]
});
...
<h2>Examples</h2><p>Check out how <a href="https://github.com/gulpjs/gulp/blob/master/bin/gulp.js">gulp</a> uses Liftoff.</p>
