...
<h1>Chokidar 1.3.0 (18 November 2015)</h1><ul>
...
<h1>Chokidar 1.2.0 (1 October 2015)</h1><ul>
...
<li>More flexible <code>ignored</code> option allowing regex, function, glob, or array courtesy of <a href="https://github.com/es128/anymatch">anymatch</a></li>
...
<li>New <code>alwaysStat</code> option to ensure <a href="https://nodejs.org/api/fs.html#fs_class_fs_stats"><code>fs.Stats</code></a> gets passed with every add/change event</li>
<li>New <code>ready</code> event emitted when initial fs tree scan is done and watcher is ready for changes</li>
<li>New <code>raw</code> event exposing data and events from the lower-level watch modules</li>
<li>New <code>followSymlinks</code> option to impact whether symlinks&#39; targets or the symlink files themselves are watched</li>
<li>New <code>atomic</code> option for normalizing artifacts from text editors that use atomic write methods</li>
<li>Ensured watcher&#39;s stability with lots of bugfixes.</li>
</ul>
<h1>Chokidar 0.12.6 (6 January 2015)</h1><ul>
<li>Fix bug which breaks <code>persistent: false</code> mode when change events occur</li>
</ul>
<h1>Chokidar 0.12.5 (17 December 2014)</h1><ul>
...
<h1>Chokidar 0.12.4 (14 December 2014)</h1><ul>
...
<h1>Chokidar 0.10.5 (6 November 2014)</h1><ul>
...
<h1>Chokidar 0.10.4 (5 November 2014)</h1><ul>
<li>Bump fsevents dependency to ~0.3.1<ul>
<li>Should resolve build warnings and <code>npm rebuild</code> on non-Macs</li>
</ul>
</li>
</ul>
<h1>Chokidar 0.10.3 (28 October 2014)</h1><ul>
...
<h1>Chokidar 0.9.0 (25 September 2014)</h1><ul>
...
<h1>Chokidar 0.7.1 (18 November 2013)</h1><ul>
<li><code>Watcher#close</code> now also removes all event listeners.</li>
</ul>
<h1>Chokidar 0.7.0 (22 October 2013)</h1><ul>
...
<h1>Chokidar 0.6.3 (12 August 2013)</h1><ul>
...
<h1>Chokidar 0.4.0 (26 July 2012)</h1><ul>
<li>Added <code>all</code> event that receives two args (event name and path) that
combines <code>add</code>, <code>change</code> and <code>unlink</code> events.</li>
<li>Switched to <code>fs.watchFile</code> on node.js 0.8 on windows.</li>
<li>Files are now correctly unwatched after unlink.</li>
</ul>
<h1>Chokidar 0.3.0 (24 June 2012)</h1><ul>
<li><code>unlink</code> event are no longer emitted for directories, for consistency
with <code>add</code>.</li>
</ul>
<h1>Chokidar 0.2.6 (8 June 2012)</h1><ul>
<li>Prevented creating of duplicate &#39;add&#39; events.</li>
</ul>
<h1>Chokidar 0.2.5 (8 June 2012)</h1><ul>
<li>Fixed a bug when new files in new directories hadn&#39;t been added.</li>
</ul>
<h1>Chokidar 0.2.4 (7 June 2012)</h1><ul>
<li>Fixed a bug when unlinked files emitted events after unlink.</li>
</ul>
<h1>Chokidar 0.2.3 (12 May 2012)</h1><ul>
<li>Fixed watching of files on windows.</li>
</ul>
<h1>Chokidar 0.2.2 (4 May 2012)</h1><ul>
<li>Fixed watcher signature.</li>
</ul>
<h1>Chokidar 0.2.1 (4 May 2012)</h1><ul>
<li>Fixed invalid API bug when using <code>watch()</code>.</li>
</ul>
<h1>Chokidar 0.2.0 (4 May 2012)</h1><ul>
<li>Rewritten in js.</li>
</ul>
<h1>Chokidar 0.1.1 (26 April 2012)</h1><ul>
<li>Changed api to <code>chokidar.watch()</code>.</li>
<li>Fixed compilation on windows.</li>
</ul>
<h1>Chokidar 0.1.0 (20 April 2012)</h1><ul>
<li>Initial release, extracted from <a href="https://github.com/brunch/brunch/blob/9847a065aea300da99bd0753f90354cde9de1261/src/helpers.coffee#L66">Brunch</a></li>
</ul>
