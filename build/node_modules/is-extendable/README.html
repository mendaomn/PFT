<h1>is-extendable <a href="http://badge.fury.io/js/is-extendable"><img src="https://badge.fury.io/js/is-extendable.svg" alt="NPM version"></a></h1><blockquote>
...
<pre><code class="language-sh">$ npm i is-extendable --save
</code></pre>
<h2>Usage</h2><pre><code class="language-js">var isExtendable = require(&#39;is-extendable&#39;);
</code></pre>
...
<h2>Notes</h2><p>All objects in JavaScript can have keys, but it&#39;s a pain to check for this, since we ether need to verify that the value is not <code>null</code> or <code>undefined</code> and:</p>
<ul>
...
<h2>Contributing</h2><p>Pull requests and stars are always welcome. For bugs and feature requests, <a href="https://github.com/jonschlinkert/is-extendable/issues/new">please create an issue</a></p>
